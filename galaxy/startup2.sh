...
show_runtime_summary() {
    ...
    local htcondor_enabled="${GALAXY_RUNNERS_ENABLE_HTCONDOR:-${GALAXY_RUNNERS_ENABLE_CONDOR:-default}}"
    ...
    log_info "  Runners: slurm=${slurm_enabled}, htcondor=${htcondor_enabled}"
